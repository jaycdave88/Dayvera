...
final class DailyTrainingStateBuilderTests: XCTestCase {
    ...
    private func trend(
        ...
        MetricTrendSeries(
            ...
            sourceBundleIdentifier: "app.dayvera.tests",
            ...
            sourceHealth: MetricSourceHealth(
                ...
                selectedBundleIdentifier: "app.dayvera.tests",
    ...
    private func makeDefaults() -> (UserDefaults, String) {
        let suiteName = "app.dayvera.training-state-tests.\(UUID().uuidString)"
