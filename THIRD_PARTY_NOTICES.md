...
The architecture and feature research also considered these open-source projects, but no source files or media were copied:

- `yuhonas/free-exercise-db` — Unlicense; excluded because the provenance of third-party photographs is less explicit than RepDB's original illustrations.
- wger — AGPL application code with per-item content licensing; not imported.
- UpLift / `danielkuhlwein/strength-training` — MIT License.
